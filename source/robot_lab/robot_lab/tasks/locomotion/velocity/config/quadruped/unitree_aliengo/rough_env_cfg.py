...
##
# use local assets
from robot_lab.assets.unitree import UNITREE_ALIENGO_CFG  # isort: skip
...
class UnitreeAliengoRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        # ------------------------------Actions------------------------------
        # reduce action scale
        self.actions.joint_pos.scale = {".*_joint": 0.5}
        ...
        if self.__class__.__name__ == "UnitreeAliengoRoughEnvCfg":
